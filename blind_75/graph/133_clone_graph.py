...
class Solution:
    def cloneGraph(self, node: Optional['Node']) -> Optional['Node']:
        ...
        # dict to store original node -> clone node map
        cloned_nodes = {}
        
        # DFS inner function to clone nodes and their neighbors
        def dfs(curr_node):
            ...
            # recursively clone neighbors and add to clone neighbor list
